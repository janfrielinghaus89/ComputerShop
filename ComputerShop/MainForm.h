...
namespace ComputerShop {
	...
	public:
		MainForm(User ^user)
		{
			...
			lbUserInfo->Text = "User-ID: " + user->id + ", Name: " + user->name + ", E-Mail: " + user->email;
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(1273, 53);
			...
			this->lbUserInfo->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lbUserInfo->Location = System::Drawing::Point(26, 96);
			...
			this->ClientSize = System::Drawing::Size(1317, 793);
